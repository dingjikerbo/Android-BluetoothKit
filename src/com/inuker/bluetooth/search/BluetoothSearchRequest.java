...
import com.inuker.bluetooth.search.classic.BluetoothClassicSearchTask;
import com.inuker.bluetooth.search.le.BluetoothLeSearchTask;
...
public class BluetoothSearchRequest {
	...
	private final BluetoothSearchResponse mBluetoothSearchResponse = new BluetoothSearchResponse() {
		...
		public void onSearchStarted() {
			// TODO Auto-generated method stub
			BluetoothUtils.log(String.format("%s onSearchStarted", mCurrentTask.toString()));
		}
		...
		public void onDeviceFounded(XmBluetoothDevice device) {
			...
			if (mCurrentTask != null) {
				BluetoothUtils.log(String.format("%s onDeviceFounded: %s", mCurrentTask.toString(), device.mac));
			} else {
				BluetoothUtils.log(String.format("onDeviceFounded: %s", device.mac));
			}
		...
		public void onSearchStopped() {
			// TODO Auto-generated method stub
			BluetoothUtils.log(String.format("%s onSearchStopped", mCurrentTask.toString()));
		...
		public void onSearchCanceled() {
			// TODO Auto-generated method stub
			BluetoothUtils.log(String.format("%s onSearchCanceled", mCurrentTask.toString()));
		}
