...
import com.inuker.bluetooth.search.classic.BluetoothClassicSearcher;
import com.inuker.bluetooth.search.le.BluetoothLESearcher;
...
public class BluetoothSearcher {
	...
	protected void notifyDeviceFounded(XmBluetoothDevice device) {
		device.mac = device.device.getAddress();
