...
public class BluetoothDeviceHandler {
	...
	public void notifyDeviceFounded(BluetoothSearchResult device, BluetoothSearchResponse response) {
	...
	private void processDeviceFounded(BluetoothSearchResult device, BluetoothSearchResponse response) {
		device.setNameFromDevice();
